"""
Debate with Physician Role Framing

Minimal modification to baseline Debate:
- Agents explicitly told they are experienced physicians
- Same architecture, just better role activation
"""
...
def run_debate_physician_role(
    ...
    """
    Debate-style dual-agent with physician role framing.
    Two physician agents debate for N rounds, then reach consensus.
    ...
    agent_a_prompt = f"""You are an experienced physician serving as Clinical Reasoning Agent A. Analyze this case and propose your diagnosis.
...
"""
    ...
    agent_b_prompt = f"""You are an experienced physician serving as Clinical Reasoning Agent B. Review Agent A's analysis and provide your perspective.
...
"""
    ...
    for round_num in range(2, rounds + 1):
        ...
        agent_a_rebuttal_prompt = f"""You are an experienced physician serving as Clinical Reasoning Agent A. This is Round {round_num} of the debate.
...
"""
        ...
        agent_b_rebuttal_prompt = f"""You are an experienced physician serving as Clinical Reasoning Agent B. This is Round {round_num} of the debate.
...
"""
    ...
    # Final consensus
    consensus_prompt = f"""You are an experienced physician moderating this clinical case discussion. Based on the debate between Agent A and Agent B, provide the final consensus answer.
