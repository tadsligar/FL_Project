...
3. Final reviewer agent synthesizes responses and makes choice (1 LLM call)
...
def run_independent_multi_agent(
    question: str,
    options: Optional[list[str]],
    llm_client: LLMClient,
    config: Config
    ...
    """
    Independent multi-agent approach:
    ...
    # Step 3: Final reviewer (5th LLM call)
