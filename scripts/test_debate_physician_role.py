#!/usr/bin/env python3
"""
Test Debate with Physician Role on MedQA questions.
"""
...
from src.baselines.debate_physician_role import run_debate_physician_role
...
def test_debate_physician_role(
    n_samples: int = 10,
    config_path: str = "configs/qwen25_32b.yaml",
    dataset_path: str = None,
    output_dir: str = "runs/debate_physician_role_test",
    rounds: int = 3
):
    """
    Test Debate with Physician Role on N questions.
    """

    console.print("\\n[bold cyan]=" * 60)
    console.print("[bold cyan]Debate with Physician Role - Test")
    ...
    with Progress(
        ...
        task = progress.add_task(
            "[cyan]Evaluating Physician Role Debate...",
            total=len(dataset)
        )
        ...
        for i, item in enumerate(dataset, 1):
            ...
            try:
                ...
                result = run_debate_physician_role(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Debate with Physician Role")
    ...
    parser.add_argument("--output", type=str, default="runs/debate_physician_role_test", help="Output directory")
    parser.add_argument("--rounds", type=int, default=3, help="Number of debate rounds")

    args = parser.parse_args()

    test_debate_physician_role(
        n_samples=args.n,
