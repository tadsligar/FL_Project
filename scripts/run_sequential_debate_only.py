#!/usr/bin/env python3
"""
Sequential Specialist Debate - Standalone Test
Runs ONLY the new Sequential Specialist Debate method on 100 questions.
"""
...
def run_sequential_debate_evaluation(
    n_samples: int = 100,
    config_path: str = "configs/qwen25_32b.yaml",
    dataset_path: str = None,
    output_dir: str = "runs/sequential_debate"
):
    """
    Run Sequential Specialist Debate on N questions.

    Args:
        n_samples: Number of questions (default 100)
    ...
    console.print("\n[bold cyan]=" * 60)
    console.print("[bold cyan]Sequential Specialist Debate Evaluation")
    ...
    with Progress(
        ...
        task = progress.add_task(
            "[cyan]Evaluating Sequential Specialist Debate...",
            total=len(dataset)
        )
        ...
        for i, item in enumerate(dataset, 1):
            ...
            try:
                ...
                result = run_sequential_specialist_debate(
                ...
                agents_used = result.get("agents_used", 3)
                generalist_type = result.get("generalist_type", "Unknown")
                ...
                results.append({
                    ...
                    "generalist_type": generalist_type,
                ...
                console.print(f"  Generalist: {generalist_type}")
                console.print(f"  Specialists: {', '.join(specialists)}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sequential Specialist Debate Evaluation")
    ...
    parser.add_argument("--output", type=str, default="runs/sequential_debate", help="Output directory")

    args = parser.parse_args()

    run_sequential_debate_evaluation(
        n_samples=args.n,
