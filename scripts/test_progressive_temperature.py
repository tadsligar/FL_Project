#!/usr/bin/env python3
"""
Test Progressive Temperature Reasoning on MedQA questions.
...
from src.baselines.progressive_temperature import run_progressive_temperature
...
def test_progressive_temperature(
    n_samples: int = 10,
    config_path: str = "configs/qwen25_32b.yaml",
    dataset_path: str = None,
    output_dir: str = "runs/progressive_temperature",
    resume_from: str = None
):
    """
    Test Progressive Temperature reasoning on N questions.
    """

    console.print("\\n[bold cyan]=" * 60)
    console.print("[bold cyan]Progressive Temperature Reasoning - Test")
    ...
    console.print(f"  Temperature schedule: 1.0 -> 0.7 -> 0.5 -> 0.3 -> 0.0\\n")
    ...
    with Progress(
        ...
        task = progress.add_task(
            "[cyan]Evaluating Progressive Temperature...",
            total=len(dataset)
        )
        ...
        for i, item in enumerate(dataset, 1):
            ...
            try:
                ...
                result = run_progressive_temperature(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Progressive Temperature Reasoning")
    ...
    parser.add_argument("--output", type=str, default="runs/progressive_temperature", help="Output directory")
    parser.add_argument("--resume", type=str, default=None, help="Resume from existing run directory (full path)")

    args = parser.parse_args()

    test_progressive_temperature(
        n_samples=args.n,
