#!/usr/bin/env python3
"""
Test Zero-Shot Baseline on MedQA questions.
The TRUE baseline - no prompting, no CoT, no debate.
"""
...
from src.baselines.zero_shot import run_zero_shot
...
def test_zero_shot(
    ...
    output_dir: str = "runs/zero_shot"
):
    """
    Test zero-shot baseline on N questions.
    """

    console.print("\n[bold cyan]=" * 60)
    console.print("[bold cyan]Zero-Shot Baseline - Test")
    ...
    with Progress(
        ...
        task = progress.add_task(
            "[cyan]Evaluating Zero-Shot Baseline...",
            total=len(dataset)
        )
        ...
        for i, item in enumerate(dataset, 1):
            ...
            try:
                ...
                result = run_zero_shot(question, options, llm_client, config)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Zero-Shot Baseline")
    ...
    parser.add_argument("--output", type=str, default="runs/zero_shot", help="Output directory")
