#!/usr/bin/env python3
"""
Test Debate with Forced Disagreement on MedQA questions.
"""
...
from src.baselines.debate_forced_disagreement import run_debate_forced_disagreement
...
def test_debate_forced_disagreement(
    n_samples: int = 10,
    config_path: str = "configs/qwen25_32b.yaml",
    dataset_path: str = None,
    output_dir: str = "runs/debate_forced_disagreement_test",
    rounds: int = 3,
    resume_from: str = None
):
    """
    Test Debate with Forced Disagreement on N questions.
    """

    console.print("\\n[bold cyan]=" * 60)
    console.print("[bold cyan]Debate with Forced Disagreement - Test")
    ...
    with Progress(
        ...
        task = progress.add_task(
            "[cyan]Evaluating Forced Disagreement Debate...",
            total=len(dataset)
        )
        ...
        for i, item in enumerate(dataset, 1):
            ...
            try:
                ...
                result = run_debate_forced_disagreement(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Debate with Forced Disagreement")
    ...
    parser.add_argument("--output", type=str, default="runs/debate_forced_disagreement_test", help="Output directory")
    ...
    test_debate_forced_disagreement(
        n_samples=args.n,
