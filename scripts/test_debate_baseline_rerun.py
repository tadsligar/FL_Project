#!/usr/bin/env python3
"""
Test Baseline Debate Rerun on MedQA questions.
"""
...
def test_debate_baseline(
    n_samples: int = 10,
    config_path: str = "configs/qwen25_32b.yaml",
    dataset_path: str = None,
    output_dir: str = "runs/debate_baseline_rerun",
    rounds: int = 3
):
    """
    Test Baseline Debate Rerun on N questions.
    """

    console.print("\\n[bold cyan]=" * 60)
    console.print("[bold cyan]Baseline Debate Rerun - Test")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Baseline Debate Rerun")
    ...
    parser.add_argument("--output", type=str, default="runs/debate_baseline_rerun", help="Output directory")
    parser.add_argument("--rounds", type=int, default=3, help="Number of debate rounds")

    args = parser.parse_args()

    test_debate_baseline(
        n_samples=args.n,
